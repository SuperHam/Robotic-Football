 ...
 * =================================================
   ...
   1.0.7 - Alex Kaariainen - removed legacy code, added many comments, re-organized portions of code and altered omni-specific code to improve QB handling and improve normal omni agility
