...
#define QB_THROWER            5
Servo qbThrower;
#define TRIANGLE_THROW        165//was 175
#define CIRCLE_THROW          125//was 125
#define CROSS_THROW           108//was 108

#define SQUARE_THROW          102
#define RELOAD_THROW          88//was 88
...
void qbThrowerCtrl()
{
  ...
  if (PS3.getButtonPress(TRIANGLE)) {
    qbThrower.write(TRIANGLE_THROW);
    }
#ifdef QB_TRACKING
...
{
  Wire.beginTransmission(slaveAddress);
  printf("\n Start that wicked nasty transmission");
  Wire.write(d1); Wire.write(d2);
  Wire.endTransmission();
  printf("\n Completded that wicked nasty transmission");
}
#endif
